...
var ASM_CONSTS = {
  5721888: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 5721949: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 5722013: function() {return Module.webglContextAttributes.powerPreference;},  
 5722071: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 5722126: function($0) {performance.now = function() { return $0; };},  
 5722174: function($0) {performance.now = function() { return $0; };},  
 5722222: function() {performance.now = Module['emscripten_get_now_backup'];}
};
...
/** @type {function(...*):?} */
var dynCall_fiiiifiifi = Module["dynCall_fiiiifiifi"] = createExportWrapper("dynCall_fiiiifiifi");

/** @type {function(...*):?} */
var dynCall_fiiiifiiifi = Module["dynCall_fiiiifiiifi"] = createExportWrapper("dynCall_fiiiifiiifi");
...
function invoke_fffiii(index,a1,a2,a3,a4,a5) {
  var sp = stackSave();
  try {
    return dynCall_fffiii(index,a1,a2,a3,a4,a5);
  } catch(e) {
    stackRestore(sp);
    if (e !== e+0) throw e;
    _setThrew(1, 0);
